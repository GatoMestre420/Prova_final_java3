...
public class Main {
    ...
    public static void main(String[] args) {
        String caminhoArquivo = "C:\\_ws\\prova_final\\prova_final\\alunos.csv";
        String caminhoResumo = "C:\\_ws\\prova_final\\prova_final\\resumo.csv";
        ...
        try (BufferedWriter escritor = new BufferedWriter(new FileWriter(caminhoResumo))) {
        ...
        System.out.println("Relatório gerado com sucesso em: " + caminhoResumo);
    }
}